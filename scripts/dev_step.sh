...
4) If you set STATE.json to REVIEW_READY, also add review_items with the file paths that should be reviewed.
5) Update STATE.json to SPEC_READY, REVIEW_READY, or DONE depending on outcome.
